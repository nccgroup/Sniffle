...
On Unix systems, this folder is typically located at ~/.config/wireshark/extcap.  Under Windows,
it can be found at %USERPROFILE%\AppData\Roaming\Wireshark\extcap.
